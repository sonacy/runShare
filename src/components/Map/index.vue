...
export default {
  ...
  methods: {
    animate (ctx) {
      ...
      this.startPoint.style.left = this.pos[0].x - this.startPoint.offsetWidth / 2 + 'px'
      ...
      const run = () => {
        if (index < this.pos.length - 3) {
          ...
          ctx.stroke()
          index++
          this.lightPoint.style.left = this.pos[index].x - this.lightPoint.offsetWidth / 2 + 'px'
          this.lightPoint.style.top = this.pos[index].y - this.lightPoint.offsetHeight / 2 + 'px'
          ...
          this.endPoint.style.left = this.pos[this.pos.length - 1].x - this.endPoint.offsetWidth / 2 + 'px'
          this.endPoint.style.top = this.pos[this.pos.length - 1].y - this.endPoint.offsetHeight / 2 + 'px'
        }
      }
      run()
    },
